<script setup>
  ...
  const { cardList, matchesFound, status, countDown, startedGame, userCanFlipCard, countVisibleCard } =
...
<template>
  <div class="game-container">
    <div style="max-height: 70px; height: 70px; overflow: hidden">
      <HeaderComponent center-text="Найди пару" center left leftLink="/"></HeaderComponent>
    </div>
    <div style="height: calc(100dvh - 70px); max-height: calc(100dvh - 70px); overflow-y: scroll; overflow-x: hidden">
      <GameTitle />
  ...
  <ModalWindow btnName="Закрыть" v-if="isModalWinVisible" @close="closeEndModal">
    <template v-slot:header>
      <img src="@/assets/svg/end-survey.svg" loading="lazy" class="header-end-image" alt="" />
  ...
  <ModalWindow btnName="Закрыть" v-if="isModalLoseVisible" @close="closeEndModal">
    <template v-slot:header>
      <img src="@/assets/svg/end-survey.svg" loading="lazy" class="header-end-image" alt="" />
