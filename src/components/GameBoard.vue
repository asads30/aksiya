<script setup>
  ...
  const { newPlayer, startedGame, countVisibleCard, userCanFlipCard } = storeToRefs(gameStore);
...
<template>
  <div class="game-status">
    ...
    <p class="timeline">
      {{
        timelineGame.secondsTimeLine.value < 10 && timelineGame.secondsTimeLine.value > 0
  ...
  <div class="myProgress">
    <div ref="progressGame" :style="{ animationPlayState: !startedGame ? 'paused' : 'running' }">
  ...
  <ModalWindow btnName="Закрыть" v-if="isModalTimeEnded" @close="isModalTimeEnded = false">
